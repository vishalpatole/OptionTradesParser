    ...
    public class Order
    {
        ...
        public override bool Equals(object p_other)
        {
            ...
            if (OrderId != l_theOther.OrderId ||
                ...
                ConditionsIncludeOvernight != l_theOther.ConditionsIncludeOvernight ||
        ...
        public override int GetHashCode()
        {
            ...
            hashCode *= -1521134295 + ConditionsIncludeOvernight.GetHashCode();
        ...
        /**
         * @brief Indicates whether or not conditions will also be valid during the OVERNIGHT trading session
         */
        public bool ConditionsIncludeOvernight { get; set; }
