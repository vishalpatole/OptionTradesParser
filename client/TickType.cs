...
namespace IBApi
{
    ...
    public class TickType
    {
        ...
        public const int ODD_LOT_BID = 105;
        public const int ODD_LOT_ASK = 106;
        public const int ODD_LOT_BID_SIZE = 107;
        public const int ODD_LOT_ASK_SIZE = 108;
        public const int ODD_LOT_BID_EXCH = 109;
        public const int ODD_LOT_ASK_EXCH = 110;
        ...
        public static string getField(int tickType)
        {
            switch (tickType)
            {
                ...
                case ODD_LOT_BID: return "oddLotBid";
                case ODD_LOT_ASK: return "oddLotAsk";
                case ODD_LOT_BID_SIZE: return "oddLotBidSize";
                case ODD_LOT_ASK_SIZE: return "oddLotAskSize";
                case ODD_LOT_BID_EXCH: return "oddLotBidExch";
                case ODD_LOT_ASK_EXCH: return "oddLotAskExch";
